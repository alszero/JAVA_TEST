...
class Summing{  // 숫자를 1~num까지 더하는 클래스
    ...
    public int getSum() {return sum;}//getSum닫음
}//Summing닫음

public class MultiThreadExam extends Thread{ //스레드
    //스레드를 상속받아서 run 메서드 구현
    ...
    public void run(){ //run 스레드로 동작할 내용을 정의 할 필요 없이
        //스레드로 동작할 메서드를 호출해도 된다.
        sum.sumTo(num);
